...
WebUI.click(findTestObject('TFSEmbed/Modules Objects/Reporting/open report in word/Page_Reporting - Microsoft Team Fou/span_MS Word'))

WebUI.click(findTestObject('TFSEmbed/Modules Objects/Reporting/open report in word/Page_Reporting - Microsoft Team Fou/input_ig-selectFile-button-ok-'))
