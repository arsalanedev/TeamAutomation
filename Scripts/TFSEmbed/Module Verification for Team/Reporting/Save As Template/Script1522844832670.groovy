...
'save as template\r\n'
WebUI.click(findTestObject('TFSEmbed/Modules Objects/Reporting/Save as Template/Page_Reporting - Microsoft Team Fou/span_Save As Template'))

'ok'
WebUI.click(findTestObject('TFSEmbed/Modules Objects/Reporting/Save as Template/Page_Reporting - Microsoft Team Fou/input_ig-filemngt-saveastempok'))

'Template File save Successfully - Notification'
WebUI.verifyElementPresent(findTestObject('TFSEmbed/Modules Objects/Reporting/Save as Template/Page_Reporting - Microsoft Team Fou (1)/span_Template File saved succe'), 
    5)
