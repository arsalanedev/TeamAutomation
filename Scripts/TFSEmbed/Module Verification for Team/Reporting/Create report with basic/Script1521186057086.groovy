...
not_run: WebUI.verifyElementNotPresent(findTestObject('TFSEmbed/Modules Objects/Reporting/create report with basic/Page_Reporting - Microsoft Team Fou/span_k-sprite rpt-mp-editor-ru'), 
    5)
