...
String callusecase = CustomKeywords.'keyword.edevkatalon.com.GeneralKeywords.GetRandomString'()
...
WebUI.setText(findTestObject('TFSEmbed/Modules Objects/Use Case/Using Callusecase/Page_Simulation and Use case - Micr/input_OpenUsecase_Name'), 
    callusecase)
...
WebUI.verifyElementPresent(findTestObject('TFSEmbed/Modules Objects/Use Case/Using Callusecase/Page_Simulation and Use case - Micr (1)/img_e-Usecase-UsecaseEditlink'), 
    0)
