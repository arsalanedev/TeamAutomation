...
WebUI.click(findTestObject('TFSEmbed/Modules Objects/Use Case/Using Callusecase/Page_Simulation and Use case - Micr/div_useCaseActionIcon e-openUs'))

WebUI.doubleClick(findTestObject('TFSEmbed/Modules Objects/Use Case/Exising call usecase/Page_Simulation and Use case - Micr/input_OpenUsecase_Dropdown'))

WebUI.setText(findTestObject('TFSEmbed/Modules Objects/Use Case/Exising call usecase/Page_Simulation and Use case - Micr/input_OpenUsecase_Dropdown'), 
    'existing')

WebUI.click(findTestObject('TFSEmbed/Modules Objects/Use Case/Exising call usecase/Page_Simulation and Use case - Micr/div_Existing UseCase'))
