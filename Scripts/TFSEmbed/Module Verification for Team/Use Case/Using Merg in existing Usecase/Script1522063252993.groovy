...
'Merge'
WebUI.click(findTestObject('TFSEmbed/Modules Objects/Use Case/Using Merge/Page_Simulation and Use case - Micr/div_e-item-overlay'))

'Select text in merge dialoge'
WebUI.click(findTestObject('TFSEmbed/Modules Objects/Use Case/Using Merge/Page_Simulation and Use case - Micr/a_1.  login'))
