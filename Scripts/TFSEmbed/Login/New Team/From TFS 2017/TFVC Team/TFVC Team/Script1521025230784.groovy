...
WebUI.click(findTestObject('TFSEmbed/Login/New Team/From TFS 2017/Team/input_version-control-types-co'))

WebUI.click(findTestObject('TFSEmbed/Login/New Team/From TFS 2017/Team/div_Team Foundation Version Co'))
